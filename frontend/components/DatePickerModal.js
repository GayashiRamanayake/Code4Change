      ...
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          ...
          <View style={styles.buttons}>
            ...
            >
              <Text style={[styles.buttonText, { color: "#fff" }]}>View History</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  modalContainer: { backgroundColor:"#fff", padding:24, borderRadius:12, width:"80%", alignItems:"center", borderWidth:2, borderColor:"#1976D2" },
  ...
  button: { padding:10, borderRadius:8, borderWidth:1, borderColor:"#1976D2", width:100, alignItems:"center", justifyContent:"center" },
